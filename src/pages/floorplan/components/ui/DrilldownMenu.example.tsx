/**
 * Example: Advanced Drilldown Menu with Nested Submenus
 *
 * This shows how to organize tools into a hierarchical menu structure
 * for your floorplan editor
 */

import { MenuItem } from './DrilldownMenu';

// Example 1: Tools menu with drawing and editing submenus
export const toolsMenuExample: MenuItem[] = [
  {
    id: 'draw',
    label: 'Draw',
    icon: (
...
// Example 2: Mode selector with grouped options
export const modeSelectorExample: MenuItem[] = [
  {
    id: 'modes',
    label: 'Editor Modes',
    icon: (
