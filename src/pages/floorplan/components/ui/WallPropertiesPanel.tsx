...
export function WallPropertiesPanel({
  ...
  return (
    <div className="absolute right-4 top-20 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 w-80 max-h-[calc(100vh-100px)] overflow-y-auto border border-gray-200 dark:border-gray-700">
      ...
      <div className="space-y-4">
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
          <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Apertures</h4>

          {/* Add Aperture Buttons */}
          <div className="flex gap-2 mb-3">
            <button
              onClick={() => startPlacingAperture('door')}
              className="flex-1 px-3 py-2 bg-blue-500 dark:bg-blue-600 text-white text-sm rounded hover:bg-blue-600 dark:hover:bg-blue-500 focus:outline-none"
            >
              + Add Door
            </button>
            <button
              onClick={() => startPlacingAperture('window')}
              className="flex-1 px-3 py-2 bg-green-500 dark:bg-green-600 text-white text-sm rounded hover:bg-green-600 dark:hover:bg-green-500 focus:outline-none"
            >
              + Add Window
            </button>
          </div>
          ...
          <div className="space-y-2">
            {(wall.apertures || []).length > 0 ? (
              (wall.apertures || []).map((aperture) => (
                <div key={aperture.id} className="p-2 bg-gray-50 dark:bg-gray-700 rounded">
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-300 space-y-1">
                    ...
                    <div className="border-b pb-1 mb-1">
                      ...
                      <div className="flex items-center gap-2">
                        {/* Visual indicator */}
                        <div className="flex items-center bg-gray-200 dark:bg-gray-600 rounded px-1 py-0.5 text-xs">
                          <span className={aperture.anchorVertex === 'start' ? 'font-bold text-gray-900 dark:text-gray-100' : 'text-gray-400 dark:text-gray-500'}>◀</span>
                          <span className="mx-1">─</span>
                          <span className="text-gray-600 dark:text-gray-300">{Math.round(aperture.distance * 100)}cm</span>
                          <span className="mx-1">→</span>
                          <span className="bg-blue-500 dark:bg-blue-600 text-white px-1 rounded">
                            {aperture.type === 'door' ? 'Door' : 'Win'}
                          </span>
                          <span className="mx-1">←</span>
                          <span className="text-gray-600 dark:text-gray-300">{Math.round((lengthM - aperture.distance - aperture.width) * 100)}cm</span>
                          <span className="mx-1">─</span>
                          <span className={aperture.anchorVertex === 'end' ? 'font-bold text-gray-900 dark:text-gray-100' : 'text-gray-400 dark:text-gray-500'}>▶</span>
                        </div>
                      </div>
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <select
                          ...
                          className="text-xs px-1 py-0.5 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded"
                        >
                        ...
                        <input
                          ...
                          className="w-14 px-1 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded text-xs"
                          min="0"
                          step="5"
                        />
                    ...
                    <div className="flex justify-between">
                      ...
                      <div className="flex items-center gap-1">
                        <input
                          ...
                          className="w-16 px-1 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded"
                          min="50"
                          max="300"
                          step="10"
                        />
