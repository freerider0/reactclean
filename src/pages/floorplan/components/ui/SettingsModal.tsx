  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 pointer-events-none p-4">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl w-full max-w-md max-h-[90vh] flex flex-col pointer-events-auto">
          {/* Header */}
          ...
          <div className="px-6 py-4 overflow-y-auto flex-1">
            ...
            {!category && (
              <div className="text-center py-8">
                ...
                <h3 className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-1">Settings</h3>
